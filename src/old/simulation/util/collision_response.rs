...
/// - ma: Mass of circle A
/// - mb: Mass of circle B
/// - crf: coefficient of restitution, the remaining kinetic energy after collision.
///        The lost energy leaves in the form of heat etc. 
...
pub(crate) fn circle_circle_collision_response(
    ...
    *va = new_velocity_i * crf;
    *vb = new_velocity_j * crf;
}

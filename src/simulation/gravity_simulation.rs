...
impl GravitySimulation {
    ...
    //                 pos, vel, pred_vel, timestep, gravity, fraction);
    //         }
    //     }
    ...
    //                 pos, vel, timestep, gravity, fraction);
    //         }
    //     }
    ...
    //         return (new_pos, new_vel); 
    //     } 
    //     return Self::circle_border_collision(
    //         pos, vel, timestep, gravity, fraction, 1);
    // }
    ...
    // ) -> (Vector3<f32>, Vector3<f32>){
    //     return Self::circle_border_collision(
    //         pos, vel, timestep, gravity, fraction, 0);
    // }
